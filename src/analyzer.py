...
7"""
    ...
    def _generate_report(self, filtered_data: dict) -> dict:
        ...
        prompt = f"""你是一个 AI 领域资深分析师。请基于以下今日 AI 领域动态，生成一份中文日报。
...
## 📰 今日热点
（从新闻热点中挑选最重要的 5-8 条，每条一句话摘要）

## 📄 论文精选
（从论文中挑选最有影响力的 3-5 篇，说明核心贡献）

## 🛠️ 开源项目
（从开源项目中挑选最值得关注的 3-5 个，说明用途和亮点）

## 💡 趋势洞察
（2-3 句话总结今日趋势，指出值得关注的技术方向）
